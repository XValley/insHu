    ...
    if($chatId == $id){
     if($text == '/start'){
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/fzz_z/12",
                   'caption'=>'𝙏𝙝𝙞𝙨 𝘽𝙤𝙩 𝙋𝙧𝙤𝙜𝙧𝙖𝙢𝙚𝙙 𝘽𝙮 : @kttkkkk 🇮🇶',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'اضافة حساب 👨🏻‍💻','callback_data'=>'login']],
                       [['text'=>"𝘿𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧", 'url'=>"https://t.me/fzz_z"]],
                      ]
                  ])
              ]);   
          } 
